...
class BaseBackend:
    """
    Copy of the default Django BaseBackend
    Changed:
    - 'get_role_permissions' renamed to 'get_role_permissions'
    """
...
class ModelBackend(BaseBackend):
    ...
    Copy of default Django ModelBackend with renaming 'group*' to 'role*'
    """
    ...
    def with_perm(self, perm, is_active=True, include_superusers=True, obj=None):
        ...
        permission_q = Q(roles__user=OuterRef("pk")) | Q(user=OuterRef("pk"))
